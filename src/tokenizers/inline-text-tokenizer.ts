import {
  InlineTextContentToken,
  InlineTextModifierToken,
  InlineModifiersList,
  InlineTextToken,
  InlineModifiers,
} from "../definations/inline-text.js";
...
export class InlineTextTokenizer {
  ...
  public static getModifierEnumKey(modifier: string) {
    switch (modifier) {
      case "_":
        return InlineModifiers.italics;
      case "*":
        return InlineModifiers.bold;
      case "~":
        return InlineModifiers.striked;
      case "`":
        return InlineModifiers.inline_code;
      default:
        return InlineModifiers.none;
    }
  }
